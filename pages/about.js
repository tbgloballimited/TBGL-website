      ...
      <div className={styles.containerTeam}>
        ...
        <div className={styles.team_cards}>
          <div className={styles.card}>
              <Image src='/img/abolanle.png' alt='Abolanle' height='230' width='200' />
              <h4>MD/PROJECT MANAGER</h4>
              <h6>Abolanle Ademola Dickson</h6>
          </div>
          <div className={styles.card}>
              <Image src='/img/sophia.png' alt='sophia' height='230' width='200' />
              <h4>FINANCIAL ANALYST</h4>
              <h6>Sophia Ihuoma Agada</h6>
          </div>
          <div className={styles.card}>
              <Image src='/img/odunmolorun.png' alt='odunmolorun' height='230' width='200' />
              <h4>CHIEF OPERATING</h4>
              <h6>Odunmolorun Oshineye</h6>
          </div>
          <div className={styles.card}>
              <Image src='/img/Babatunde.png' alt='babatunde' height='230' width='200' />
              <h4>CHIEF ENGINEER</h4>
              <h6>Babatunde Adedayo Oniyitan</h6>
          </div>
          <div className={styles.card}>
              <Image src='/img/Frevbenagie.png' alt='frevbenagie' height='230' width='200' />
              <h4>CHIEF SITE ENGINEER</h4>
              <h6>Frevbenagie Henry</h6>
          </div>
          <div className={styles.card}>
              <Image src='/img/josiah.png' alt='josiah' height='230' width='200' />
